      ...
      <div className="w-[50%] h-full flex items-center justify-center">
        <div className="w-[60%] h-auto p-[20px] rounded-lg flex flex-col bg-[#1f1f1f]">
          <div className="w-full flex flex-col">
             ...
             <div className="w-[200px] h-[4px] rounded-lg bg-[#183f99]"></div>
          </div>
          <div className="w-full flex flex-col">
              <div className="mt-4">
          ...
          <div className="w-full flex flex-col items-center justify-center">
              <button
                className="mt-[20px] w-full h-[50px] bg-[#271ea8] rounded-lg text-white font-bold"
              ...
              <div className="w-full flex justify-center flex-col">
                  ...
                  <div className="w-full py-4 flex">
                    <div className="w-[20%] flex flex-col items-center justify-center">
                      <p className="text-[40px] text-[#776fdb]">{resultado}</p>
                  ...
                  <div className="w-full flex items-center justify-center">
                    <a className="text-[rgb(43,201,203)] mt-4" href="">Mais informações sobre o IMC</a>
                  </div>
              </div>
            )
          }
